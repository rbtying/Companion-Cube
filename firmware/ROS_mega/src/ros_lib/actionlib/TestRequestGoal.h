...
namespace actionlib
{
  ...
  class TestRequestGoal : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->is_simple_client);
      this->delay_accept.sec |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      offset += sizeof(this->delay_accept.sec);
      this->delay_accept.nsec |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      offset += sizeof(this->delay_accept.nsec);
      this->delay_terminate.sec |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      offset += sizeof(this->delay_terminate.sec);
      this->delay_terminate.nsec |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      offset += sizeof(this->delay_terminate.nsec);
      this->pause_status.sec |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      offset += sizeof(this->pause_status.sec);
      this->pause_status.nsec |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
