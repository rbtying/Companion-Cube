#ifndef _ROS_rover_Battery_h
#define _ROS_rover_Battery_h
...
namespace rover
{
  ...
  class Battery : public ros::Msg
  {
    ...
    const char * getType(){ return "rover/Battery"; };
    const char * getMD5(){ return "75c8e4b7132acff3b679451f5604f145"; };
