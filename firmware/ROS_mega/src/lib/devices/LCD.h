...
public:
	LCD(uint8_t rs, uint8_t enable, uint8_t d0, uint8_t d1,
			uint8_t d2, uint8_t d3, uint8_t d4, uint8_t d5, uint8_t d6,
			uint8_t d7);
	LCD(uint8_t rs, uint8_t rw, uint8_t enable, uint8_t d0,
			uint8_t d1, uint8_t d2, uint8_t d3, uint8_t d4, uint8_t d5,
			uint8_t d6, uint8_t d7);
	LCD(uint8_t rs, uint8_t rw, uint8_t enable, uint8_t d0,
			uint8_t d1, uint8_t d2, uint8_t d3);
	LCD(uint8_t rs, uint8_t rw, uint8_t enable, uint8_t en2,
	...
	LCD(uint8_t rs, uint8_t rw, uint8_t enable, uint8_t en2,
			uint8_t d0, uint8_t d1, uint8_t d2, uint8_t d3, void(*userFunc)(
					int8_t chip)); //4x40 LCD w 2x HD44780 controller chips, 2 enable lines to select between them   4 data pins
	LCD(uint8_t rs, uint8_t enable, uint8_t d0, uint8_t d1,
			uint8_t d2, uint8_t d3);
	LCD(uint8_t rs, uint8_t enable, uint8_t d0, uint8_t d1,
			uint8_t d2, uint8_t d3, void(*userFunc)(int8_t chip)); //just define user busy flag test for the 2 forms I want to promote; deprecate 8 pins and RW;

	void init(uint8_t rs, uint8_t rw, uint8_t enable, uint8_t en2, uint8_t d0,
			uint8_t d1, uint8_t d2, uint8_t d3, void(*userFunc)(int8_t chip));
	...
	inline LCD& operator()(uint8_t x, uint8_t y) {
		setCursor(x, y);
		return *this;
	} //use along w Streaming.h to support: lcd(col,line)<<"a="<<a;
	uint8_t numlines;
	uint8_t numcols;
protected:
