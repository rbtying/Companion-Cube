...
public:
	// public methods
	RoboClaw(HardwareSerial * hws, uint32_t baud);
	~RoboClaw();
	...
	int32_t ReadEncM1(uint8_t address, uint8_t *status = NULL,
			bool *valid = NULL);
	int32_t ReadEncM2(uint8_t address, uint8_t *status = NULL,
			bool *valid = NULL);
	int32_t ReadSpeedM1(uint8_t address, uint8_t *status = NULL,
			bool *valid = NULL);
	int32_t ReadSpeedM2(uint8_t address, uint8_t *status = NULL,
			bool *valid = NULL);
	...
	void SetM1Constants(uint8_t address, uint32_t Kd, uint32_t Kp, uint32_t Ki,
			uint32_t qpps);
	void SetM2Constants(uint8_t address, uint32_t Kd, uint32_t Kp, uint32_t Ki,
			uint32_t qpps);
	...
	void SpeedAccelM1M2(uint8_t address, uint32_t accel, uint32_t speed1,
			uint32_t speed2);
	void SpeedDistanceM1(uint8_t address, uint32_t speed, uint32_t distance,
			uint8_t flag = 0);
	void SpeedDistanceM2(uint8_t address, uint32_t speed, uint32_t distance,
			uint8_t flag = 0);
	void SpeedDistanceM1M2(uint8_t address, uint32_t speed1,
			uint32_t distance1, uint32_t speed2, uint32_t distance2,
			uint8_t flag = 0);
	void SpeedAccelDistanceM1(uint8_t address, uint32_t accel, uint32_t speed,
			uint32_t distance, uint8_t flag = 0);
	void SpeedAccelDistanceM2(uint8_t address, uint32_t accel, uint32_t speed,
			uint32_t distance, uint8_t flag = 0);
	void SpeedAccelDistanceM1M2(uint8_t address, uint32_t accel,
	...
	void SpeedAccelM1M2_2(uint8_t address, uint32_t accel1, uint32_t speed1,
			uint32_t accel2, uint32_t speed2);
	void SpeedAccelDistanceM1M2_2(uint8_t address, uint32_t accel1,
			uint32_t speed1, uint32_t distance1, uint32_t accel2,
	...
	void DutyAccelM1M2(uint8_t address, uint16_t duty1, uint16_t accel1,
...
private:
	...
	uint32_t
	Read4_1(uint8_t address, uint8_t cmd, uint8_t *status, bool *valid);
