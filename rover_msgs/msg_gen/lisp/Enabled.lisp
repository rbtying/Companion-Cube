...
(cl:defmethod cl:initialize-instance :after ((m <Enabled>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Enabled)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rover_msgs-msg:<Enabled> is deprecated: use rover_msgs-msg:Enabled instead.")))

(cl:ensure-generic-function 'motorsEnabled-val :lambda-list '(m))
(cl:defmethod motorsEnabled-val ((m <Enabled>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_msgs-msg:motorsEnabled-val is deprecated.  Use rover_msgs-msg:motorsEnabled instead.")
  (motorsEnabled m))

(cl:ensure-generic-function 'settingsDumpEnabled-val :lambda-list '(m))
(cl:defmethod settingsDumpEnabled-val ((m <Enabled>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_msgs-msg:settingsDumpEnabled-val is deprecated.  Use rover_msgs-msg:settingsDumpEnabled instead.")
